...
//
// Add custom-post-type (by inc/custom_posts.php)
//
...
//
//       Enable only ACF Gutenberg Blocs - de-comment or add original guttenberg-blocks in the array( core/ ....)
//  
function filter_allowed_block_types_when_post_provided(
    $allowed_block_types,
    $editor_context
): array {

    $registered_blocks = \App\Blocs\Bloc::$allowed_blocks;
...
add_filter(
    ...
    'filter_allowed_block_types_when_post_provided',
    10,
    2
);


\App\Blocs\BlocOptions::register();
\App\Blocs\BlocTest::register();
\App\Blocs\BlocTailwind::register();
