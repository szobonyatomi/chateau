    ...
    <div class="min-h-screen bg-slate-50 dark:bg-black dark:text-white">
        ...
        <div class="max-w-4xl mx-auto main-block">
            <section id="hero"
                ...
                <img class="w-1/2" src="<?php echo get_template_directory_uri(); ?>/assets/images/rocketdab.png" alt="Rocker Dab">
            </section>
            ...
            <section id="rockets" class="min-h-screen p-6 my-12 scroll-mt-20">
                ...
                <ul class="flex flex-col items-center gap-8 mx-auto my-12 list-none sm:flex-row">
                    <li
                        ...
                        <img class="w-1/2 mb-6" src="<?php echo get_template_directory_uri(); ?>/assets/images/rocketman.png"
                            alt="Rocket man">
                    ...
                    <li
                        class="flex flex-col items-center w-2/3 px-2 py-6 bg-white border border-solid shadow-xl sm:w-5/6 border-slate-900 dark:border-gray-100 rounded-3xl dark:bg-black">
                        <img class="w-1/2 mb-6" src="<?php echo get_template_directory_uri(); ?>/assets/images/rocketride.png"
                            alt="Adventure">
                        <h3 class="text-3xl text-center text-slate-900 dark:text-white">
                            Adventure
                        </h3>
                    ...
                    <li
                        class="flex flex-col items-center w-2/3 px-2 py-6 bg-white border border-solid shadow-xl sm:w-5/6 border-slate-900 dark:border-gray-100 rounded-3xl dark:bg-black">
                        <img class="w-1/2 mb-6" src="<?php echo get_template_directory_uri(); ?>/assets/images/rocketlaunch.png"
                            alt="Infinity">
...
<?php /**PATH /Users/tomi/works/Labo/wordplateXtra/resources/views/bloc/tailwind.blade.php ENDPATH**/ ?>